...
def rating_filter(model):
    
    # dynamically imported module
    module = importlib.import_module(f"systems.{model}")
    attributes = ["a", "D"]
...
player_info = rating_filter(data,model)
